...
const Section1 = () => {
  return (
    <section className="bg-shell pb-24 pt-47">
      ...
      <p className="text-pretty w-144 mt-5 text-base text-ink/75 md:text-lg">
        Discover, engage, and convert leads across multiple platforms powered by
        AI automation, analytics, and campaigns built for growth.
      </p>
