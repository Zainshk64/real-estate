      ...
      <div className="mx-auto w-full max-w-6xl  px-4 space-y-10">
        ...
        >
          <div className="bg-[var(--color-sand)] rounded-xl shadow-md p-8 w-full md:w-1/3">
            ...
            <p>
              Search by business type, location, and rating to collect fresh,
              targeted leads.
            </p>
          </div>
          <div className="bg-[var(--color-clay)] text-white rounded-xl shadow-md p-8 w-full md:w-1/3">
            ...
            <p>
              Run automated campaigns across multiple platforms and score lead
              engagement.
            </p>
          </div>
          <div className="bg-[var(--color-sand)] rounded-xl shadow-md p-8 w-full md:w-1/3">
            ...
            <p>
              View analytics, assign leads, and close deals faster with your
              team dashboard.
            </p>
          </div>
        </motion.div>
