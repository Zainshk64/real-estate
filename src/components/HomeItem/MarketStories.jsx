...
function MarketStories() {
  return (
    <section className="bg-shell  py-20">
      <div className="mx-auto w-full px-4 max-w-6xl space-y-12">
        <SectionHeader
          eyebrow="Market Stories "
          title="Explore the worlds shaping tomorrow’s lifestyles"
          description="From AI-powered wellness hubs to green smart cities, each category spotlights innovation transforming how we live, work, and connect."
        />
          ...
          >
            ...
            <div className="space-y-4 p-6">
              ...
              <p className="text-sm text-ink/70">
                Explore how hybrid hospitality bridges the expectations of
                global buyers seeking flexible, resilient residences designed
                for both calm and productivity.
              </p>
              <a
                href="#"
          ...
          {stories.slice(1).map((story, index) => (
            ...
            >
              ...
              <div className="space-y-3 p-6">
                ...
                <a
                  href={story.url}
                  className="text-sm font-semibold text-forest transition hover:text-ink"
                >
                  Learn more →
                </a>
              </div>
